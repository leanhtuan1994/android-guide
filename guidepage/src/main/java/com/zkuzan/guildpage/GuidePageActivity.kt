    ...
    private fun init() {
        ...
        tvSkip?.apply {
            ...
            (this as? TextView)?.let {
                GuidePageSpec.skipTextAppearance.takeIf { GuidePageSpec.skipTextAppearance != R.style.GuidePage_SkipTextAppearance }
                    ?.apply {
                ...
                GuidePageSpec.skipText?.takeIf { !TextUtils.isEmpty(GuidePageSpec.skipText) }
                    ?.apply {
                        it.text = this
                    }
            }
        ...
        circleIndicator?.apply {
            visibility = if (GuidePageSpec.showIndicator) View.VISIBLE else View.GONE
        ...
        viewPager.registerOnPageChangeCallback(object : ViewPager2.OnPageChangeCallback() {
            override fun onPageScrolled(
                ...
                GuidePageSpec.onGuidePageChangeCallback?.onPageScrolled(
                    position,
                    positionOffset,
